                ...
                <div class="col-12">
                    <div class="card my-4">
                        ...
                        <div class="card-body px-0 pb-2">
                            <a class="btn btn-primary" href="<?= base_url() ?>backend/member/createUser">+ Tambah Data</a>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($member as $f) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="align-middle text-center text-sm"><?= $f->username ?></td>
                                                        ...
                                                        <td class="align-middle text-center text-sm">
                                                            <a class="btn btn-warning" href="<?= base_url() ?>backend/member/editMember/<?php echo $f->id_user; ?>"><i class="fa fa-edit"></i>Edit</a>
