...
<section id="profile">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-15" style="height: 50%; width: 100%;">
        <!-- Collapsable Card Example -->
        <div class="card shadow mb-6">
          <!-- Card Header - Accordion -->
          <a class="d-block card-header py-3 align-center" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
            <center>
              <h6 class="m-0 font-weight-bold text-primary">Cek Jadwal</h6>
            </center>
          </a>
          <?php
