...
class Member extends CI_Controller
{
	...
	public function about()
	{
		...
		$config = array();
		$config['center'] = "-6.192267, 106.886666";
		$config['zoom'] = 15;
		$config['map_height'] = "400px";
		$this->googlemaps->initialize($config);

		$marker = array();
		$marker['position'] = "-6.192267, 106.886666";
	...
	function profile_act()
	{
		...
		if (!empty($pass)) {
			$hash_pass = md5($pass); // bisa diganti password_hash() untuk lebih aman
		} else {
			$hash_pass = $password_lama->password; // gunakan password lama
		}
